                ...
                <div className="col" data-aos="fade-right">
                    <div className="card card-portfolio1">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://seansean30.github.io/portfolio/Projects" className="nav-link" aria-current="page" class="btn btn-primary">Weekend Summary Sample</a>
                        </div>
                    </div>
                </div>
                <div className="col" data-aos="fade-up">
                    <div className="card card-portfolio1">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://seansean30.github.io/portfolio/Projects" className="nav-link" aria-current="page" class="btn btn-primary">CSS Fundamentals Sample</a>
                        </div>
                    </div>
                </div>
                <div className="col" data-aos="fade-up">
                    <div className="card card-portfolio1">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://seansean30.github.io/portfolio/Projects" className="nav-link" aria-current="page" class="btn btn-primary">NodeJS Sample</a>
                        </div>
                    </div>
                </div>
                <div className="col" data-aos="fade-left">
                    <div className="card card-portfolio1">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://seansean30.github.io/portfolio/Projects" className="nav-link" aria-current="page" class="btn btn-primary">Portfolio Sample</a>
                        </div>
                    </div>
                </div>
            </div>
